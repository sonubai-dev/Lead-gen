    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 font-sans">
        <motion.div 
          ...
          className="glass-card p-8 rounded-2xl flex flex-col items-center max-w-sm w-full text-center"
        >
          <div className="w-16 h-16 bg-slate-900 rounded-2xl flex items-center justify-center mb-6 shadow-xl shadow-slate-200">
            <Sparkles className="text-white w-8 h-8" />
          </div>
          <h1 className="text-2xl font-bold text-slate-900 mb-2">LeadGen AI</h1>
          <p className="text-slate-500 mb-8">Professional lead management & automation platform.</p>
